...
- \R via \pkg{RcppRedis} utilising the [hiredis][hiredis] library
...
the [hiredis][hiredis] library to \R.  A simple \R example inline with above
follows
...
We can do the same in \Py. Here we showing only the final intersect command, the set-addition
