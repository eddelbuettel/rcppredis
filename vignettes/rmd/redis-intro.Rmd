...
[Redis][redis] \citep{Redis} is an very popular, very powerful, and very widely-used 'in-memory database-structure
...
and writing differently data types from different programming languages including \R, \Py and shell
